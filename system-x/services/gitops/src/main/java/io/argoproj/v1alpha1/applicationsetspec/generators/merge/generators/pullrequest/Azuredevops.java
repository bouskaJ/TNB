...
public class Azuredevops implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.argoproj.v1alpha1.applicationsetspec.generators.merge.generators.pullrequest.azuredevops.TokenRef tokenRef;

    public io.argoproj.v1alpha1.applicationsetspec.generators.merge.generators.pullrequest.azuredevops.TokenRef getTokenRef() {
        return tokenRef;
    }

    public void setTokenRef(io.argoproj.v1alpha1.applicationsetspec.generators.merge.generators.pullrequest.azuredevops.TokenRef tokenRef) {
