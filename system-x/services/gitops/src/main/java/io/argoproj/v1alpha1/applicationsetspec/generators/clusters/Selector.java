...
public class Selector implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.argoproj.v1alpha1.applicationsetspec.generators.clusters.selector.MatchExpressions> matchExpressions;

    public java.util.List<io.argoproj.v1alpha1.applicationsetspec.generators.clusters.selector.MatchExpressions> getMatchExpressions() {
        return matchExpressions;
    }

    public void setMatchExpressions(java.util.List<io.argoproj.v1alpha1.applicationsetspec.generators.clusters.selector.MatchExpressions> matchExpressions) {
