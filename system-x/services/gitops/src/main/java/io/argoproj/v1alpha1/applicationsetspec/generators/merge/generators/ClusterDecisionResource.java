...
public class ClusterDecisionResource implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.argoproj.v1alpha1.applicationsetspec.generators.merge.generators.clusterdecisionresource.LabelSelector labelSelector;

    public io.argoproj.v1alpha1.applicationsetspec.generators.merge.generators.clusterdecisionresource.LabelSelector getLabelSelector() {
        return labelSelector;
    }

    public void setLabelSelector(io.argoproj.v1alpha1.applicationsetspec.generators.merge.generators.clusterdecisionresource.LabelSelector labelSelector) {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.argoproj.v1alpha1.applicationsetspec.generators.merge.generators.clusterdecisionresource.Template template;

    public io.argoproj.v1alpha1.applicationsetspec.generators.merge.generators.clusterdecisionresource.Template getTemplate() {
        return template;
    }

    public void setTemplate(io.argoproj.v1alpha1.applicationsetspec.generators.merge.generators.clusterdecisionresource.Template template) {
