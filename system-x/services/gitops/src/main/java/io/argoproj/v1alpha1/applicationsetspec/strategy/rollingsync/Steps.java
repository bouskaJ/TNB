package io.argoproj.v1alpha1.applicationsetspec.strategy.rollingsync;
...
public class Steps implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.argoproj.v1alpha1.applicationsetspec.strategy.rollingsync.steps.MatchExpressions> matchExpressions;

    public java.util.List<io.argoproj.v1alpha1.applicationsetspec.strategy.rollingsync.steps.MatchExpressions> getMatchExpressions() {
        return matchExpressions;
    }

    public void setMatchExpressions(java.util.List<io.argoproj.v1alpha1.applicationsetspec.strategy.rollingsync.steps.MatchExpressions> matchExpressions) {
