...
public class AwsCodeCommit implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.argoproj.v1alpha1.applicationsetspec.generators.matrix.generators.scmprovider.awscodecommit.TagFilters> tagFilters;

    public java.util.List<io.argoproj.v1alpha1.applicationsetspec.generators.matrix.generators.scmprovider.awscodecommit.TagFilters> getTagFilters() {
        return tagFilters;
    }

    public void setTagFilters(java.util.List<io.argoproj.v1alpha1.applicationsetspec.generators.matrix.generators.scmprovider.awscodecommit.TagFilters> tagFilters) {
