...
public class BitbucketServer implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.argoproj.v1alpha1.applicationsetspec.generators.matrix.generators.pullrequest.bitbucketserver.BasicAuth basicAuth;

    public io.argoproj.v1alpha1.applicationsetspec.generators.matrix.generators.pullrequest.bitbucketserver.BasicAuth getBasicAuth() {
        return basicAuth;
    }

    public void setBasicAuth(io.argoproj.v1alpha1.applicationsetspec.generators.matrix.generators.pullrequest.bitbucketserver.BasicAuth basicAuth) {
