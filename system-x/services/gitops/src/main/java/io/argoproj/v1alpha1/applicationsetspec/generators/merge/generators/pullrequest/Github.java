...
public class Github implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.argoproj.v1alpha1.applicationsetspec.generators.merge.generators.pullrequest.github.TokenRef tokenRef;

    public io.argoproj.v1alpha1.applicationsetspec.generators.merge.generators.pullrequest.github.TokenRef getTokenRef() {
        return tokenRef;
    }

    public void setTokenRef(io.argoproj.v1alpha1.applicationsetspec.generators.merge.generators.pullrequest.github.TokenRef tokenRef) {
