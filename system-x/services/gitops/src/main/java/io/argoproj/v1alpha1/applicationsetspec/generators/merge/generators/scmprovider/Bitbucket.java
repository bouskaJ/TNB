...
public class Bitbucket implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.argoproj.v1alpha1.applicationsetspec.generators.merge.generators.scmprovider.bitbucket.AppPasswordRef appPasswordRef;

    public io.argoproj.v1alpha1.applicationsetspec.generators.merge.generators.scmprovider.bitbucket.AppPasswordRef getAppPasswordRef() {
        return appPasswordRef;
    }

    public void setAppPasswordRef(io.argoproj.v1alpha1.applicationsetspec.generators.merge.generators.scmprovider.bitbucket.AppPasswordRef appPasswordRef) {
