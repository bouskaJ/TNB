...
public class Git implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.argoproj.v1alpha1.applicationsetspec.generators.matrix.generators.git.Directories> directories;

    public java.util.List<io.argoproj.v1alpha1.applicationsetspec.generators.matrix.generators.git.Directories> getDirectories() {
        return directories;
    }

    public void setDirectories(java.util.List<io.argoproj.v1alpha1.applicationsetspec.generators.matrix.generators.git.Directories> directories) {
        this.directories = directories;
    }

    @com.fasterxml.jackson.annotation.JsonProperty("files")
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.argoproj.v1alpha1.applicationsetspec.generators.matrix.generators.git.Files> files;

    public java.util.List<io.argoproj.v1alpha1.applicationsetspec.generators.matrix.generators.git.Files> getFiles() {
        return files;
    }

    public void setFiles(java.util.List<io.argoproj.v1alpha1.applicationsetspec.generators.matrix.generators.git.Files> files) {
        this.files = files;
    }
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private io.argoproj.v1alpha1.applicationsetspec.generators.matrix.generators.git.Template template;

    public io.argoproj.v1alpha1.applicationsetspec.generators.matrix.generators.git.Template getTemplate() {
        return template;
    }

    public void setTemplate(io.argoproj.v1alpha1.applicationsetspec.generators.matrix.generators.git.Template template) {
