...
public class OrphanedResources implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.List<io.argoproj.v1alpha1.appprojectspec.orphanedresources.Ignore> ignore;

    public java.util.List<io.argoproj.v1alpha1.appprojectspec.orphanedresources.Ignore> getIgnore() {
        return ignore;
    }

    public void setIgnore(java.util.List<io.argoproj.v1alpha1.appprojectspec.orphanedresources.Ignore> ignore) {
        this.ignore = ignore;
    }
