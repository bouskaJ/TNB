...
public class Kustomize implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    @com.fasterxml.jackson.annotation.JsonSetter(nulls = com.fasterxml.jackson.annotation.Nulls.SKIP)
    private java.util.List<io.argoproj.v1alpha1.applicationsetspec.generators.pullrequest.template.spec.sources.kustomize.Replicas> replicas;

    public java.util.List<io.argoproj.v1alpha1.applicationsetspec.generators.pullrequest.template.spec.sources.kustomize.Replicas> getReplicas() {
        return replicas;
    }

    public void setReplicas(java.util.List<io.argoproj.v1alpha1.applicationsetspec.generators.pullrequest.template.spec.sources.kustomize.Replicas> replicas) {
