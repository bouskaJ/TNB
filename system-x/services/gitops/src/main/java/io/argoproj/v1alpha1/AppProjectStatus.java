...
public class AppProjectStatus implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private java.util.Map<java.lang.String, io.argoproj.v1alpha1.appprojectstatus.JwtTokensByRole> jwtTokensByRole;

    public java.util.Map<java.lang.String, io.argoproj.v1alpha1.appprojectstatus.JwtTokensByRole> getJwtTokensByRole() {
        return jwtTokensByRole;
    }

    public void setJwtTokensByRole(java.util.Map<java.lang.String, io.argoproj.v1alpha1.appprojectstatus.JwtTokensByRole> jwtTokensByRole) {
