...
public class AzureDevOps implements io.fabric8.kubernetes.api.model.KubernetesResource {
    ...
    private io.argoproj.v1alpha1.applicationsetspec.generators.merge.generators.scmprovider.azuredevops.AccessTokenRef accessTokenRef;

    public io.argoproj.v1alpha1.applicationsetspec.generators.merge.generators.scmprovider.azuredevops.AccessTokenRef getAccessTokenRef() {
        return accessTokenRef;
    }

    public void setAccessTokenRef(io.argoproj.v1alpha1.applicationsetspec.generators.merge.generators.scmprovider.azuredevops.AccessTokenRef accessTokenRef) {
